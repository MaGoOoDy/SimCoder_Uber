...
public class RiderLoginActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (v.getId() ) {
                ...
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            Toast.makeText(RiderLoginActivity.this, "Error during registering", Toast.LENGTH_SHORT).show();
            ...
            case R.id.btn_login:
                ...
                mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            Toast.makeText(RiderLoginActivity.this, "Error during logging", Toast.LENGTH_SHORT).show();
                            //Todo: -  better to make all the possibilities of the login errors ...... [ check the firebase docs ]

                        }else{
                            Toast.makeText(RiderLoginActivity.this, "log in successfully", Toast.LENGTH_SHORT).show();
